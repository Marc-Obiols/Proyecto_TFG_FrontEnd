...
import com.example.proyecto_tfg_frontend.Actividades.Rutina;
                    ...
                    confirmar.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (nom.equals("")){
                                ...
                                con.execute(URL+"rutina/modificar/" + listDatos.get(posicion).getId(), "POST", req.toString());
                ...
                public void onClick(View v) {
                    ...
                    confirmar.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            llamada = 3;
                            Connection con = new Connection((Interfaz) c);
                            con.execute(URL+"rutina/eliminar/" + listDatos.get(posicion).getId(), "POST", req.toString());
                            pantalla_eliminar.dismiss();
                        }
                    });
